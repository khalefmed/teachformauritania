...
export const WhyUs = () => {
    ...
    return (
        <section className=' max-w-screen overflow-hidden p-28 max-lg:p-16 flex flex-col gap-16 max-sm:gap-8 max-sm:px-4'>
            { i18n.language == "ar" 
            ? 
            <h1 className='text-center max-md:text-3xl text-transparent bg-clip-text font-bold  text-4xl  uppercase bg-gradient-to-r from-main to-second'>{t('why_us')}</h1>
            : 
            <h1 className='text-center max-md:text-3xl text-transparent bg-clip-text font-bold  text-4xl tracking-[0.25rem] uppercase bg-gradient-to-r from-main to-second'>{t('why_us')}</h1>
            }
            ...
            <div className={'flex flex-row flex-wrap  justify-center gap-16 py-0 max-sm:px-4   lg:hidden ' + (i18n.language === "ar" ? "border-r-2 border-main" : "border-l-2 border-main")}>
            <motion.div
                initial = {{
