    ...
    return (
        <section id='hero' className='px-28 max-md:px-20 max-sm:px-8 flex flex-row max-lg:flex-col-reverse max-lg:gap-2 align-center justify-between max-md:justify-center items-center min-h-[calc(100vh-100px)] max-lg:min-h-screen   '>
            <div className='w-1/2 max-lg:w-full max-lg:text-center max-lg:items-center flex flex-col gap-5 '>
                <h3 className='text-blackColor text-4xl max-md:text-3xl max-sm:text-2xl font-black font-sora bg-clip-text text-transparent bg-gradient-to-r from-blackColor  to-secondBlackColor'>Votre partenaire pour des solutions IT stratégiques et performantes</h3>
                <p className='text-blackColor text-lg max-md:text-lg max-sm:text-sm font-medium'>Avec Lynaat, bénéficiez de solutions complètes en Développement Web, Cybersécurité, et Intelligence Artificielle, pour transformer votre entreprise et atteindre vos objectifs commerciaux</p>
                <a href="#contact" className='px-4 py-3 flex flex-row align-center justify-center items-center gap-2 text-white w-fit bg-gradient-to-r from-blackColor   to-secondBlackColor rounded-lg shadow-lg shadow-shadow'>
                    <span className='text-sm'>Discuttons</span>
            ...
            <div className=' w-[350px]    relative  flex justify-center align-center items-center h-[350px] max-lg:h-[350px]'>
                ...
                <p className='w-36 py-2 max-md:w-24 text-center max-md:text-xs shadow-lg shadow-whiteShadow bottom-8 right-16 max-lg:bottom-24 max-lg:right-28 bg-white rounded-lg absolute font-medium text-blackColor'>Efficacité</p>
                <p className='w-36 py-2 max-md:w-24 text-center max-md:text-xs shadow-lg shadow-whiteShadow top-10 left-16 max-lg:top-24 max-lg:left-28 bg-white rounded-lg absolute font-medium text-blackColor'>Convivialité</p>
                <p className='w-36 py-2 max-md:w-24 text-center max-md:text-xs shadow-lg shadow-shadow left-0 top- max-lg:top-42   max-lg:left-12 bg-blackColor rounded-lg absolute font-medium text-white'>Competence</p>
                <p className='w-36 py-2 max-md:w-24 text-center max-md:text-xs shadow-lg shadow-shadow right-0 top-32 max-lg:top-36 max-lg:right-16 bg-blackColor rounded-lg absolute font-medium text-white'>Performance</p>
            </div>
        </section>
    )
}
