...
export const Partners = () => {
    ...
    return (
        partners ? <section id='partners' className='max-w-screen overflow-hidden max-w-screen px-28 py-20 flex flex-col gap-16 max-lg:p-16 max-sm:px-0 max-sm:8'>
        ...
        <div className='flex flex-row max-md:flex-col  flex-wrap   items-center max-sm:items-center justify-center '>
                <div className='w-[200px] px-6 py-8 flex flex-row items-center max-md:flex-col justify-center gap-16'>
                    ...
                    src={urlFor(item.logo).width(80).url() }
                     alt="" />)}
                    {/* <motion.img
                    initial = {{
                        x : 0,
