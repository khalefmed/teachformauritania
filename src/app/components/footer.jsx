        ...
        (contact && <footer className='flex flex-row max-sm:flex-col max-sm:justify-start max-sm:gap-16 justify-between bg-main px-28 py-8 max-sm:px-8 max-w-screen'>
            ...
            <div className='flex flex-col max-sm:items-start gap-3'>
                ...
                <div className=' text-sm flex flex-row justify-center gap-2 text-cardGrey'>
                    <a href={contact.linkedin} target="_blank"><img src="images/linkedin_icon.png" width={30} alt="" /></a>
                    <a href={contact.facebook} target="_blank"><img src="images/facebook_icon.png" width={30} alt="" /></a>
                    <a href={contact.instagram} target="_blank"><img src="images/instagram.png" width={30} alt="" /></a>
                    <a href={contact.tiktok} target="_blank"><img src="images/tiktok.png" width={30} alt="" /></a>
                </div>
            </div>
        </footer>)
    )
